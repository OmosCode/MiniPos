        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UrunAnagrup = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RemovedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Statu = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rec_Categories", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnaGrupID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recetes_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Recetes_rec_Categories_AnaGrupID",
                        column: x => x.AnaGrupID,
                        principalTable: "rec_Categories",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Baskets_Recetes_ReceteID",
                        column: x => x.ReceteID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SatisHrk", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SatisHrk_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SatisHrk_Recetes_ReceteID",
                        column: x => x.ReceteID,
                        principalTable: "Recetes",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Baskets_ReceteID",
                table: "Baskets",
                column: "ReceteID");

            migrationBuilder.CreateIndex(
                name: "IX_Recetes_AnaGrupID",
                table: "Recetes",
                column: "AnaGrupID");

            migrationBuilder.CreateIndex(
                name: "IX_Recetes_AppUserId",
                table: "Recetes",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SatisHrk_AppUserId",
                table: "SatisHrk",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SatisHrk_ReceteID",
                table: "SatisHrk",
                column: "ReceteID");
        }
